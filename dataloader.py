...
class BaseDataset(Dataset):
    def __init__(self, path, do_train):
        if do_train:
        ...
        self.indices_test = pkl.load(open(f"../audio-retrieval/data/AudioCaps/structured-symlinks/test_index_search.pkl", "rb"))
        self.num_samples_test = self.indices_test.shape[0]
        ...
        self.index_corrects_test = np.array(range(self.num_samples_test)).reshape(self.num_samples_test, 1)
        self.values_test = self.num_samples_test == self.index_corrects_test
