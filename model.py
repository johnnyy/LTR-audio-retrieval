...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.position_embeddings = nn.Embedding(640, config.hidden_size)
...
class BertFinetun(nn.Module):
    def __init__(self, config):
        ...
        self.proj_a = nn.Conv1d(29,30, kernel_size=1, padding=0, bias=False)
    ...
    def forward(self, hidden_states,pooled_output,audio_data,attention_mask):
        ...
        audio_data = self.proj_a(audio_data.float())
        audio_data = audio_data.transpose(1, 2)
...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def forward(self, input_ids, all_audio_data,token_type_ids=None, attention_mask=None, query_index=None, label_index=None):
        import pdb;pdb.set_trace()
